...
![Экран напоминания](docs/alert-ru.png)
...
Права на сеть у приложения нет вовсе, так что отправить куда-то ваши данные оно
технически неспособно. Подробности: [политика конфиденциальности](PRIVACY.md).
